...
import vnpt.it3.treeviewlib.animator.TreeItemAnimator;
import vnpt.it3.treeviewlib.base.BaseNodeViewFactory;
import vnpt.it3.treeviewlib.base.SelectableTreeAction;
...
public class TreeView implements SelectableTreeAction {
    ...
    private TreeViewAdapter.OnClickItemListener onClickListener;
    ...
    private RecyclerView buildRootView() {
        ...
        adapter = new TreeViewAdapter(context, root, baseNodeViewFactory,onClickListener);
    ...
    public void setDefaultNodeClickListener(TreeViewAdapter.OnClickItemListener listener) {
