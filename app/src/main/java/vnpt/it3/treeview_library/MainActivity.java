...
import vnpt.it3.treeviewlib.TreeView;
import vnpt.it3.treeviewlib.TreeViewAdapter;

public class MainActivity extends AppCompatActivity implements TreeViewAdapter.OnClickItemListener {
   ...
   /* @Override
    ...
    @Override
    public void onDetailClick(TreeNode treeNode, Object position) {
        Toast.makeText(this,treeNode.getValue().toString(),Toast.LENGTH_LONG).show();
    }
}
